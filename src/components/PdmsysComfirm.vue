<template slot-scope='scope'>
  <div>
    ...
    <el-table :data="tables.slice((currentPage-1)*PageSize,currentPage*PageSize)" style="width: 100%" stripe align="center"
      ...
      <el-table-column label="款式号" prop="styleCode" align="center" width="110px" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column label="样品类型" prop="SampleStyle" width="90px" align="center"></el-table-column>
      <el-table-column label="样衣类型" prop="colthType" width="70px" align="center" show-overflow-tooltip></el-table-column>
      ...
      <el-table :data="gridTable" class="template-list" v-loading="tableLoading">
        ...
        <el-table-column property="Timer" label="实际完成日期" align="center">
          <template slot-scope='scope'>
            ...
            <div v-else>
              <el-date-picker v-model="scope.row.Timer" type="datetime" placeholder="选择日期时间" align="center"
                default-time="12:00:00" clearable value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
            </div>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getPdmInfo: function () {
      // console.log('重新加载了')
      var that = this
      that.$axios.get('/PDM/BLL/GetPdmCompleteResult', { // 这里将axios.get 改为this.$axios.get
        params: {}
      }).then(resp => {
